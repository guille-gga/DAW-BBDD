...
Es el lugar donde se deposita la información sobre la totalidad de los datos
que forman la BD. Contiene las características lógicas de las estructuras que almacenan los datos, su
nombre, descripción, contenido y organización. En una BD relacional, el diccionario de datos aportará
información sobre:
